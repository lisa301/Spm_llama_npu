...
// pub fn get_inference_device(force_cpu: bool, devices: &[usize]) -> Result<Vec<Device>> {
//     if force_cpu {
//         log::debug!("device is forced cpu");
...
//         if used_devices.contains(ordinal) {
//             continue;
//         }
//         used_devices.insert(*ordinal);

//         if cuda_is_available() {
//             log::debug!("device is cuda {ordinal}");
//             result.push(Device::new_cuda(*ordinal)?);
//         } else if metal_is_available() {
//             log::debug!("device is metal {ordinal}");
//             result.push(Device::new_metal(*ordinal)?);
//         } else {
//             log::debug!("device is cpu");
//             result.push(Device::Cpu);
//         }
//     }
